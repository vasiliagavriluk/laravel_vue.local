<?php //f3de74676892fbe118c75379be019dab
/** @noinspection all */
...
namespace App\Models {
     ...
     * @mixin _IH_Blog_QB
     * @method static BlogFactory factory(array|callable|int|null $count = null, array|callable $state = [])
     */
     ...
     * @foreignLinks id,\App\Models\Blog,user_id
     * @mixin _IH_User_QB
